# PlayerokCardinal
[![telegram](https://img.shields.io/badge/telegram-@KaDerix-blue?style=for-the-badge&logo=telegram)](https://t.me/KaDerix)
[![python](https://img.shields.io/badge/python-3.11%2B-yellow?style=for-the-badge&logo=python)](https://www.python.org/downloads/)
[![stars](https://img.shields.io/github/stars/KITUSTTT/PlayerokCardinal?style=for-the-badge&logo=github&color=43d433)](https://github.com/KITUSTTT/PlayerokCardinal/stargazers)
[![forks](https://img.shields.io/github/forks/KITUSTTT/PlayerokCardinal?style=for-the-badge&logo=github&color=6c70e6)](https://github.com/KITUSTTT/PlayerokCardinal/fork)

Мощный бот для автоматизации работы с Playerok 🤖🟦
...
- [Управление (Linux)](#-управление-linux)
- [🔄 Руководство по обновлению](UPDATE_GUIDE.md)
- [🧩 Гайд по созданию плагинов](PLUGINS_GUIDE.md)
...
1. Скачайте проект (Code → Download ZIP) и распакуйте
2. Запустите `Setup.bat` для установки зависимостей
3. Запустите `Start.bat` для первого запуска
4. Следуйте инструкциям на экране (бот спросит токены и пароли)

### 🐧 Linux (Ubuntu/Debian)

**Автоматическая установка в 3 команды:**
...
📖 **[Подробная инструкция для Linux →](INSTALL_LINUX.md)**

После установки управляйте ботом через systemd:
...
Управление ботом через systemd service:
...
⚠️ Замените `username` на имя пользователя, которое указали при установке.

📖 **[Полная документация →](INSTALL_LINUX.md)**
...
## 🔗 Полезные ссылки
- **Разработчик**: [KaDerix](https://github.com/KITUSTTT) (в профиле есть актуальные ссылки на все контакты для связи)
